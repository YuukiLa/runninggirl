...
return function ()
    ...
    function _M.getRoad()
        ...
        -- 背景的植物
        group:insert(plantFactory.getMushroom(ipw + 108 * 2, iph - 128 * 2 - 64 + 15))
        group:insert(plantFactory.getTree(ipw + 108 * 17, iph - 128 * 4 + 15))
        group:insert(plantFactory.getTree(ipw + 108 * 8, iph - 128 * 5 + 15))
        ...
        group:insert(roadFactory.getFloatRoad(ipw + 108 * 8, iph - 128 * 3))
        group:insert(star().createStar(ipw + 108 * 8 + 15, iph - 128 * 3 - 90)) 
        group:insert(roadFactory.getFloatRoad(ipw + 108 * 9, iph - 128 * 3))
        --左边地板
        group:insert(roadFactory.getLeftRoad(ipw + 108 * 11, iph - 128 * 2))
        --中间地板
        for i = 12, 17 do
            group:insert(roadFactory.getMidRoad(ipw + 108 * i, iph - 128 * 2))
            group:insert(star().createStar(ipw + 108 * i + 15, iph - 128 * 2 - 90))
